      ...
      <div class="row mt-5">
        <div class="col-lg-6 col-sm-12 mb-sm-3">
          <div class="card mx-auto">
            ...
            <div class="card-body">
              <form method="post" action="./viewAta.php">
                <div class="mb-3 position-relative">
                  ...
                  <input
                    ...
                    placeholder="Ex: Elaboração para plano de ensino..."
                  />
                ...
                <div class="mb-3">
                  <label for="detalhes" id="detalhes" class="form-label"
                    >Detalhes</label
                  >
                  <textarea
                    class="form-control"
          ...
          <div class="card-header">
            ...
            <div class="card-footer">
              <div class="d-flex justify-content-end">
                <input class="btn btn-primary botaoEnviar" type="submit" value="Visualizar Documento">
              </div>
            </div>
            </form>
          </div>
